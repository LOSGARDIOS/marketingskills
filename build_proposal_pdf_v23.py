...
<div class="page">
  ...
  <div style="display:grid;grid-template-columns:2fr 3fr;gap:3mm;height:155mm">
    ...
    <!-- Right: dominant heritage image -->
    <div style="overflow:hidden;border-radius:4px;position:relative">
      <img src="{umbro_heritage_uri}" style="width:100%;height:100%;object-fit:cover;display:block">
      <div style="position:absolute;top:0;left:0;right:0;background:linear-gradient(180deg,rgba(0,26,62,0.7) 0%,rgba(0,26,62,0) 40%)">
        <div style="padding:3mm 4mm;color:#fff">
          <div style="font-size:7px;letter-spacing:.15em;font-weight:800;text-transform:uppercase;opacity:.9">Heritage Kit · 1924</div>
          <div style="font-size:6px;opacity:.7">Diamond DNA · British Football Authority</div>
        </div>
      </div>
      <div style="position:absolute;bottom:0;left:0;right:0;background:linear-gradient(0deg,rgba(0,26,62,0.85) 0%,rgba(0,26,62,0) 60%);padding:4mm 4mm 3mm">
        <div style="display:flex;align-items:center;gap:2mm">
          <img src="{umbro_logo_uri}" style="height:8mm;width:auto;filter:brightness(0) invert(1)">
          <div style="color:#aac8ff;font-size:7px;font-weight:800">T1 · Official Brand Asset · CONF 0.97</div>
        </div>
      </div>
    </div>
  </div>
...
<div class="page">
  ...
  <div style="position:relative;height:118mm;overflow:hidden;border-radius:4px;margin-bottom:2.5mm">
    <img src="{umbro_f4_uri}" style="width:100%;height:100%;object-fit:cover;display:block;object-position:center 30%">
  ...
  <div style="margin-bottom:1.5mm">
    <div style="font-size:7px;font-weight:800;text-transform:uppercase;color:#003f8a;margin-bottom:1.5mm;letter-spacing:.08em">LTAM Collection — ציוד קבוצות ישראל (B2B) · T2 Authentic Documentation</div>
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:2mm">
      <div style="border-radius:4px;overflow:hidden;border:1.5px solid #003f8a;position:relative">
        <img src="{umbro_ltam_j_uri}" style="width:100%;height:28mm;object-fit:cover;display:block">
      ...
      <div style="border-radius:4px;overflow:hidden;border:1.5px solid #003f8a;position:relative">
        <img src="{umbro_style1_uri}" style="width:100%;height:28mm;object-fit:cover;display:block">
        <div style="background:rgba(0,26,62,0.85);padding:1mm 2mm;text-align:center">
          <div style="color:#fff;font-size:6px;font-weight:700">Style Collection 1</div>
          <div style="color:#aac8ff;font-size:5.5px">Club Wear · Training</div>
        </div>
      </div>
      <div style="border-radius:4px;overflow:hidden;border:1.5px solid #003f8a;position:relative">
        <img src="{umbro_style2_uri}" style="width:100%;height:28mm;object-fit:cover;display:block">
        <div style="background:rgba(0,26,62,0.85);padding:1mm 2mm;text-align:center">
          <div style="color:#fff;font-size:6px;font-weight:700">Style Collection 2</div>
          <div style="color:#aac8ff;font-size:5.5px">Match Day · Training</div>
        </div>
      </div>
      <div style="border-radius:4px;overflow:hidden;border:1.5px solid #1a4a8a;position:relative">
        <img src="{umbro_f3_uri}" style="width:100%;height:28mm;object-fit:cover;display:block;object-position:center center">
        <div style="background:rgba(0,26,62,0.85);padding:1mm 2mm;text-align:center">
          <div style="color:#fff;font-size:6px;font-weight:700">Football Action</div>
          <div style="color:#aac8ff;font-size:5.5px">Footvolley · Street Football</div>
        </div>
      </div>
    </div>
  </div>
...
<div class="page">
  ...
  <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:2.5mm">
    <div style="border-radius:4px;overflow:hidden;border:1.5px solid #006b3a;position:relative">
      <img src="{padel_womens_uri}" style="width:100%;height:32mm;object-fit:cover;display:block;object-position:center top">
      <div style="background:rgba(0,40,20,0.88);padding:1.5mm 2mm;text-align:center">
        <div style="color:#fff;font-size:6.5px;font-weight:700">Women's Padel</div>
        <div style="color:#a0e8c0;font-size:5.5px">נשים · 55% שוק · הזדמנות ראשית</div>
      </div>
    </div>
    <div style="border-radius:4px;overflow:hidden;border:1.5px solid #006b3a;position:relative">
      <img src="{padel_racket_uri}" style="width:100%;height:32mm;object-fit:cover;display:block;object-position:center center">
      <div style="background:rgba(0,40,20,0.88);padding:1.5mm 2mm;text-align:center">
        <div style="color:#fff;font-size:6.5px;font-weight:700">Padel Racket Collection</div>
        <div style="color:#a0e8c0;font-size:5.5px">ציוד Umbro · ₪350-650/רקטה</div>
      </div>
    </div>
    <div style="border-radius:4px;overflow:hidden;border:1.5px solid #006b3a;position:relative">
      <img src="{padel_friends_uri}" style="width:100%;height:32mm;object-fit:cover;display:block;object-position:center center">
      <div style="background:rgba(0,40,20,0.88);padding:1.5mm 2mm;text-align:center">
        <div style="color:#fff;font-size:6.5px;font-weight:700">Community × Friends</div>
        <div style="color:#a0e8c0;font-size:5.5px">מסלול חברים · WhatsApp D2C</div>
      </div>
    </div>
  </div>
</div>
...
<div class="page">
  ...
  <div style="display:grid;grid-template-columns:2fr 3fr;gap:3mm;height:155mm">
    ...
    <!-- Right: product gallery top + LAFW hero bottom -->
    <div style="display:flex;flex-direction:column;gap:2mm">
      <!-- Product gallery 4-col -->
      <div style="font-size:6px;font-weight:800;text-transform:uppercase;color:#5b1fa8;letter-spacing:.08em;margin-bottom:0.5mm">קולקציה — T2 Authentic Products</div>
      <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:1.5mm">
        <div style="border-radius:3px;overflow:hidden;border:1.5px solid #5b1fa8;position:relative">
          <img src="{tiger_tee_uri}" style="width:100%;height:22mm;object-fit:cover;display:block;object-position:center top">
          <div style="background:rgba(26,0,51,0.88);padding:1mm;text-align:center">
            <div style="color:#fff;font-size:5.5px;font-weight:700">Tiger Tee</div>
            <div style="color:#d6c6f0;font-size:5px">₪260-320</div>
          </div>
        </div>
        <div style="border-radius:3px;overflow:hidden;border:1.5px solid #5b1fa8;position:relative">
          <img src="{skull_hoodie_uri}" style="width:100%;height:22mm;object-fit:cover;display:block;object-position:center top">
          <div style="background:rgba(26,0,51,0.88);padding:1mm;text-align:center">
            <div style="color:#fff;font-size:5.5px;font-weight:700">Skull Hoodie</div>
        ...
        <div style="border-radius:3px;overflow:hidden;border:1.5px solid #7b3fcf;position:relative">
          <img src="{barrow_uri}" style="width:100%;height:22mm;object-fit:cover;display:block;object-position:center center">
          <div style="background:rgba(26,0,51,0.88);padding:1mm;text-align:center">
        ...
        <div style="border-radius:3px;overflow:hidden;border:1.5px solid #7b3fcf;position:relative">
          <img src="{palm_angels_uri}" style="width:100%;height:22mm;object-fit:cover;display:block;object-position:center top">
          <div style="background:rgba(26,0,51,0.88);padding:1mm;text-align:center">
            <div style="color:#fff;font-size:5.5px;font-weight:700">Palm Angels</div>
            <div style="color:#d6c6f0;font-size:5px">Streetwear Ref</div>
          </div>
        </div>
      </div>
      <!-- Ed Hardy session images 3-col -->
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:1.5mm">
        <div style="border-radius:3px;overflow:hidden;border:1px solid #3a0066">
          <img src="{img6952_uri}" style="width:100%;height:20mm;object-fit:cover;display:block;object-position:center center">
        </div>
        <div style="border-radius:3px;overflow:hidden;border:1px solid #3a0066">
          <img src="{img6954_uri}" style="width:100%;height:20mm;object-fit:cover;display:block;object-position:center center">
        </div>
        <div style="border-radius:3px;overflow:hidden;border:1px solid #3a0066">
          <img src="{img6956_uri}" style="width:100%;height:20mm;object-fit:cover;display:block;object-position:center center">
        </div>
      </div>
      <!-- LAFW hero bottom -->
      <div style="overflow:hidden;border-radius:4px;position:relative;flex:1;min-height:40mm">
        <img src="{lafw_uri}" style="width:100%;height:100%;object-fit:cover;display:block;object-position:center top">
        <div style="position:absolute;top:0;left:0;right:0;background:linear-gradient(180deg,rgba(26,0,51,0.8) 0%,rgba(26,0,51,0) 45%)">
          <div style="padding:2mm 3mm">
            <div style="color:#d6c6f0;font-size:6px;letter-spacing:.12em;font-weight:800;text-transform:uppercase">T1 · LA Fashion Week · Gen-Z חזרה</div>
          </div>
        </div>
        <div style="position:absolute;bottom:0;left:0;right:0;background:linear-gradient(0deg,rgba(26,0,51,0.9) 0%,rgba(26,0,51,0) 70%);padding:2mm 3mm">
          <div style="color:rgba(255,255,255,0.7);font-size:6px">CONF 0.91 · Pinterest ↑340% · TikTok "Bring Back Ed Hardy" פעיל</div>
        </div>
      </div>
    </div>
  </div>
...
<div class="page">
  ...
  <div class="c2">
    <div>
      ...
      <div style="background:#f8f5fc;border:1px solid #d6c6f0;border-radius:5px;padding:3mm">
        ...
        <svg viewBox="0 0 240 310" style="width:100%;height:auto;display:block" xmlns="http://www.w3.org/2000/svg">
          <!-- Stage 1: Discovery -->
...
html_path = f"{S}/intermax-lgg-proposal-v23.html"
pdf_path  = f"{S}/intermax-lgg-proposal-v23.pdf"
...
dest = "/home/user/marketingskills/intermax-lgg-proposal-v23.pdf"
