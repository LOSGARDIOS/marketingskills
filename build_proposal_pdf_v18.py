...
<div class="page cover" style="padding:0">
  ...
  <div class="cbot">
    ...
    <span>LGG-IMX-2026 | v18 | מסמך סודי</span>
  </div>
</div>
""")
...
<div class="page">
  ...
  <div style="background:#fdf3d8;border:1px solid #e8cc80;border-radius:5px;padding:2.5mm 3mm;margin-bottom:2.5mm;font-size:8px">
    ...
    <span style="color:#888;font-size:7px">תקציב ראשי: Ed Hardy + Umbro (M1-M6) → הרחבה לReplay/Steve Madden (M7+)</span>
  </div>
...
<div class="page">
  ...
  <div style="margin-top:5mm;text-align:center;font-size:7px;color:var(--im);border-top:1px solid var(--rule);padding-top:2mm">
    © 2026 Los Gardios Group | ח.פ. 516819257 | losgardios.com | LGG-IMX-2026-001 | v18 | מסמך סודי — לא להפצה
  </div>
</div>
...
html_path = f"{S}/intermax-lgg-proposal-v18.html"
pdf_path  = f"{S}/intermax-lgg-proposal-v18.pdf"
...
dest = "/home/user/marketingskills/intermax-lgg-proposal-v18.pdf"
