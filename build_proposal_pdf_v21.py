...
with open(f"{S}/umbro_ltam_green_b64.txt") as f:
    umbro_ltam_green = f.read().strip()
...
umbro_green_uri     = f"data:image/jpeg;base64,{umbro_ltam_green}"
...
<div class="page cover" style="padding:0">
  ...
  <div class="cbot">
    ...
    <span>LGG-IMX-2026 | v21 | מסמך סודי</span>
  </div>
</div>
""")
...
<!-- עמוד 3a: Umbro — Visual Gallery + Research Context -->
<div class="page">
  <div class="ph" style="background:linear-gradient(90deg,#001a3e,#003f8a)"><img src="{chrome_uri}" alt=""><span class="wm">03a — Umbro Israel — גלריית מוצרים + מחקר מותג</span><span class="ey">Visual Research</span></div>
  <div class="stag" style="color:#003f8a">03a — UMBRO ISRAEL — PRODUCT GALLERY · BRAND RESEARCH</div>

  <!-- Logo + Title Row -->
  <div style="display:flex;align-items:center;gap:3mm;margin-bottom:3mm">
    <img src="{umbro_logo_uri}" style="height:10mm;width:auto">
    <div>
      <div style="font-size:10px;font-weight:800;color:#001a3e;text-transform:uppercase;letter-spacing:.1em">Umbro Football Heritage 1924</div>
      <div style="font-size:7.5px;color:#555">מותג כדורגל בריטי אותנטי · ציוד ישראל · B2B קבוצות</div>
    </div>
  </div>

  <!-- Row 1: Hero + Heritage -->
  <div style="display:grid;grid-template-columns:2fr 1fr 1fr;gap:2mm;margin-bottom:2mm">
    <div style="border-radius:5px;overflow:hidden;position:relative;background:#001a3e">
      <img src="{umbro_cover_uri}" style="width:100%;height:45mm;object-fit:cover;display:block">
      <div style="position:absolute;bottom:0;left:0;right:0;background:rgba(0,26,62,0.88);padding:1.5mm 2mm;text-align:center">
        <div style="color:#aac8ff;font-size:6.5px;font-weight:800;text-transform:uppercase">קמפיין ראשי 2025</div>
        <div style="color:#fff;font-size:6px">Hero Campaign Visual · Season Launch</div>
      </div>
    </div>
    <div style="border-radius:5px;overflow:hidden;position:relative;background:#001a3e">
      <img src="{umbro_heritage_uri}" style="width:100%;height:45mm;object-fit:cover;display:block">
      <div style="position:absolute;bottom:0;left:0;right:0;background:rgba(0,26,62,0.85);padding:1.5mm 2mm;text-align:center">
        <div style="color:#aac8ff;font-size:6.5px;font-weight:800;text-transform:uppercase">Heritage Kit</div>
        <div style="color:#fff;font-size:6px">DNA בריטי 1924 · Diamond Logo</div>
      </div>
    </div>
    <div style="border-radius:5px;overflow:hidden;position:relative;background:#001a3e">
      <img src="{umbro_fotbol_uri}" style="width:100%;height:45mm;object-fit:cover;display:block">
      <div style="position:absolute;bottom:0;left:0;right:0;background:rgba(0,26,62,0.85);padding:1.5mm 2mm;text-align:center">
        <div style="color:#aac8ff;font-size:6.5px;font-weight:800;text-transform:uppercase">Football DNA</div>
        <div style="color:#fff;font-size:6px">היסטוריית קבוצות · Pitch Heritage</div>
      </div>
    </div>
  </div>

  <!-- Row 2: LTAM / Israeli Teams B2B section -->
  <div style="margin-bottom:2mm">
    <div style="font-size:7px;font-weight:800;text-transform:uppercase;color:#003f8a;margin-bottom:1.5mm;letter-spacing:.08em">ציוד קבוצות ישראל (B2B) — LTAM Collection</div>
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:2mm">
      <div style="border-radius:5px;overflow:hidden;border:1.5px solid #003f8a;position:relative">
        <img src="{umbro_ltam_j_uri}" style="width:100%;height:32mm;object-fit:cover;display:block">
        <div style="position:absolute;bottom:0;left:0;right:0;background:rgba(0,26,62,0.82);padding:1mm 2mm;text-align:center">
          <div style="color:#fff;font-size:6px">LTAM Team Jerseys · קבוצות</div>
        </div>
      </div>
      <div style="border-radius:5px;overflow:hidden;border:1.5px solid #003f8a;position:relative">
        <img src="{umbro_style1_uri}" style="width:100%;height:32mm;object-fit:cover;display:block">
        <div style="position:absolute;bottom:0;left:0;right:0;background:rgba(0,26,62,0.82);padding:1mm 2mm;text-align:center">
          <div style="color:#fff;font-size:6px">Style Collection 1 · Club Wear</div>
        </div>
      </div>
      <div style="border-radius:5px;overflow:hidden;border:1.5px solid #003f8a;position:relative">
        <img src="{umbro_style2_uri}" style="width:100%;height:32mm;object-fit:cover;display:block">
        <div style="position:absolute;bottom:0;left:0;right:0;background:rgba(0,26,62,0.82);padding:1mm 2mm;text-align:center">
          <div style="color:#fff;font-size:6px">Style Collection 2 · Training</div>
        </div>
      </div>
      <div style="border-radius:5px;overflow:hidden;border:1.5px solid #1a7a4a;position:relative">
        <img src="{umbro_green_uri}" style="width:100%;height:32mm;object-fit:cover;display:block">
        <div style="position:absolute;bottom:0;left:0;right:0;background:rgba(0,62,30,0.82);padding:1mm 2mm;text-align:center">
          <div style="color:#fff;font-size:6px">LTAM Green · ₪150-320</div>
        </div>
      </div>
    </div>
  </div>

  <!-- Row 3: Football Campaign activations + Lifestyle -->
  <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:2mm">
    <div style="border-radius:5px;overflow:hidden;position:relative;background:#001a3e">
      <img src="{umbro_f3_uri}" style="width:100%;height:28mm;object-fit:cover;display:block">
      <div style="position:absolute;bottom:0;left:0;right:0;background:rgba(0,26,62,0.82);padding:1mm 2mm;text-align:center">
        <div style="color:#aac8ff;font-size:6px;font-weight:700">Football Campaign</div>
        <div style="color:#fff;font-size:5.5px">קמפיין כדורגל · Activation</div>
      </div>
    </div>
    <div style="border-radius:5px;overflow:hidden;position:relative;background:#001a3e">
      <img src="{umbro_f4_uri}" style="width:100%;height:28mm;object-fit:cover;display:block">
      <div style="position:absolute;bottom:0;left:0;right:0;background:rgba(0,26,62,0.82);padding:1mm 2mm;text-align:center">
        <div style="color:#aac8ff;font-size:6px;font-weight:700">Match Day</div>
        <div style="color:#fff;font-size:5.5px">יום משחק · Fan Experience</div>
      </div>
    </div>
    <div style="border-radius:5px;overflow:hidden;position:relative;background:#001a3e">
      <img src="{umbro_f5_uri}" style="width:100%;height:28mm;object-fit:cover;display:block">
      <div style="position:absolute;bottom:0;left:0;right:0;background:rgba(0,26,62,0.82);padding:1mm 2mm;text-align:center">
        <div style="color:#aac8ff;font-size:6px;font-weight:700">Street Football</div>
        <div style="color:#fff;font-size:5.5px">פוטבול רחוב · Urban</div>
      </div>
    </div>
    <div style="border-radius:5px;overflow:hidden;position:relative;background:#001a3e">
      <img src="{umbro_garden_uri}" style="width:100%;height:28mm;object-fit:cover;display:block">
      <div style="position:absolute;bottom:0;left:0;right:0;background:rgba(0,26,62,0.82);padding:1mm 2mm;text-align:center">
        <div style="color:#aac8ff;font-size:6px;font-weight:700">Lifestyle · Community</div>
        <div style="color:#fff;font-size:5.5px">קהילת ספורט · גרופ שוט</div>
      </div>
    </div>
  </div>
</div>
...
html_path = f"{S}/intermax-lgg-proposal-v21.html"
pdf_path  = f"{S}/intermax-lgg-proposal-v21.pdf"
...
dest = "/home/user/marketingskills/intermax-lgg-proposal-v21.pdf"
