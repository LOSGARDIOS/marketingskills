...
<div class="page">
  ...
  <div style="margin-bottom:1.5mm">
    ...
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:2mm">
      ...
      <div style="border-radius:4px;overflow:hidden;border:1.5px solid #003f8a;position:relative">
        <img src="{brasil_tank_uri}" style="width:100%;height:28mm;object-fit:cover;display:block;object-position:center top">
        <div style="background:rgba(0,26,62,0.85);padding:1mm 2mm;text-align:center">
      ...
      <div style="border-radius:4px;overflow:hidden;border:1.5px solid #009c3b;position:relative">
        <img src="{swebo_brasil_uri}" style="width:100%;height:28mm;object-fit:cover;display:block;object-position:center top">
...
html_path = f"{S}/intermax-lgg-proposal-v25.html"
pdf_path  = f"{S}/intermax-lgg-proposal-v25.pdf"
...
dest = "/home/user/marketingskills/intermax-lgg-proposal-v25.pdf"
