...
<div class="page">
  ...
  <div style="display:grid;grid-template-columns:2fr 3fr;gap:3mm;height:155mm">
    ...
    <div style="overflow:hidden;border-radius:4px;position:relative">
      <img src="{umbro_heritage_uri}" style="width:100%;height:100%;object-fit:cover;display:block;object-position:center top">
...
html_path = f"{S}/intermax-lgg-proposal-v27.html"
pdf_path  = f"{S}/intermax-lgg-proposal-v27.pdf"
...
dest = "/home/user/marketingskills/intermax-lgg-proposal-v27.pdf"
