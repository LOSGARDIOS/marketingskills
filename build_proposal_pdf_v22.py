...
<div class="page cover" style="padding:0">
  ...
  <div class="cbot">
    ...
    <span>LGG-IMX-2026 | v22 | מסמך סודי</span>
  </div>
</div>
""")
...
<div class="page">
  ...
  <div style="position:relative;height:118mm;overflow:hidden;border-radius:4px;margin-bottom:2.5mm">
    <img src="{umbro_cover_uri}" style="width:100%;height:100%;object-fit:cover;display:block">
  ...
  <div style="margin-bottom:1.5mm">
    ...
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:2mm">
      ...
      <div style="border-radius:4px;overflow:hidden;border:1.5px solid #1a7a4a;position:relative">
        <img src="{umbro_green_uri}" style="width:100%;height:28mm;object-fit:cover;display:block">
        <div style="background:rgba(0,62,30,0.85);padding:1mm 2mm;text-align:center">
          <div style="color:#fff;font-size:6px;font-weight:700">LTAM Green</div>
          <div style="color:#aacca8;font-size:5.5px">₪150-320 · Club Edition</div>
        </div>
      </div>
    </div>
  </div>
...
<div class="page">
  ...
  <div style="display:grid;grid-template-columns:2fr 3fr;gap:3mm;height:155mm">
    ...
    <!-- Right: LAFW dominant image -->
    <div style="overflow:hidden;border-radius:4px;position:relative">
      <img src="{lafw_uri}" style="width:100%;height:100%;object-fit:cover;display:block;object-position:center top">
      <div style="position:absolute;top:0;left:0;right:0;background:linear-gradient(180deg,rgba(26,0,51,0.8) 0%,rgba(26,0,51,0) 35%)">
        <div style="padding:3mm 4mm">
          <div style="color:#d6c6f0;font-size:7px;letter-spacing:.15em;font-weight:800;text-transform:uppercase">T1 · Official Brand Asset</div>
          <div style="color:#fff;font-size:8px;font-weight:700">LA Fashion Week — Gen-Z חזרה</div>
        </div>
      </div>
      <div style="position:absolute;bottom:0;left:0;right:0;background:linear-gradient(0deg,rgba(26,0,51,0.9) 0%,rgba(26,0,51,0) 60%);padding:3mm 4mm">
        <div style="color:#d6c6f0;font-size:7px;letter-spacing:.1em;font-weight:800">Y2K חוזר · Gen-Z ישראל לא חווה את שלב הרוויה</div>
        <div style="color:rgba(255,255,255,0.7);font-size:6.5px;margin-top:0.5mm">CONF 0.91 · Pinterest ↑340% · TikTok "Bring Back Ed Hardy" פעיל</div>
      </div>
    </div>
  </div>
...
<div class="page">
  ...
  <div style="position:relative;height:115mm;overflow:hidden;border-radius:4px;margin-bottom:3mm">
    <img src="{umbro_garden_uri}" style="width:100%;height:100%;object-fit:cover;display:block;object-position:center center">
...
<div class="page">
  ...
  <div style="margin-top:5mm;text-align:center;font-size:7px;color:var(--im);border-top:1px solid var(--rule);padding-top:2mm">
    © 2026 Los Gardios Group | ח.פ. 516819257 | losgardios.com | LGG-IMX-2026-001 | v22 | מסמך סודי — לא להפצה
  </div>
</div>
...
html_path = f"{S}/intermax-lgg-proposal-v22.html"
pdf_path  = f"{S}/intermax-lgg-proposal-v22.pdf"
...
dest = "/home/user/marketingskills/intermax-lgg-proposal-v22.pdf"
