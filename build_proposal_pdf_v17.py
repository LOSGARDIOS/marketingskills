...
<div class="page cover" style="padding:0">
  ...
  <div class="cbot">
    ...
    <span>LGG-IMX-2026 | v17 | מסמך סודי</span>
  </div>
</div>
""")
...
<div class="page">
  ...
  <div style="margin-top:5mm;text-align:center;font-size:7px;color:var(--im);border-top:1px solid var(--rule);padding-top:2mm">
    © 2026 Los Gardios Group | ח.פ. 516819257 | losgardios.com | LGG-IMX-2026-001 | v17 | מסמך סודי — לא להפצה
  </div>
</div>
...
html_path = f"{S}/intermax-lgg-proposal-v17.html"
pdf_path  = f"{S}/intermax-lgg-proposal-v17.pdf"
...
dest = "/home/user/marketingskills/intermax-lgg-proposal-v17.pdf"
